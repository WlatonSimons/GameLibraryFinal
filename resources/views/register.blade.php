<div class="body"></div>
		...
		<div class="login">
            ...
            <form method="POST" action="{{url('/main/register')}}" class="loginForm">
                {{ csrf_field()}}
                <div class="header">
                    <div>Game<span>Catalogue</span></div>
                </div>
                <pre> <input type="text" name="name" class="form-control" placeholder="Username"/><pre> 
                ...
                <pre> <input type="password" name="password_confirmation" placeholder="Confirm password" class="form-control"/></pre>
                <pre><input type="submit" name="login" class="btn-btn-primary" value="Register"/><pre>
            <pre>         <a href="{{ url('/login')}}">I have an account !</a></pre>
            </form>
